...
class Fraction:
  ...
  def __lt__(self, other):
    result = (self.__n * other.__d) - (other.__n * self.__d)
    if result < 0:
      return True
    return False
...
if __name__ == '__main__':
  ...
  print(Fraction(1,3) == Fraction(2,6))
  print(Fraction(7,37) == Fraction(3,13))


  print(Fraction(2,3) < Fraction(3,5))
  print(Fraction(3,5) < Fraction(2,3))

#Create Tree
a = Binary_Search_Tree()
fractions = [[1,3],[5,33],[3,39],[98,74],[1,12],[3,16],[1,8]]

for i in fractions:
  a.insert_element(Fraction(i[0],i[1]))
